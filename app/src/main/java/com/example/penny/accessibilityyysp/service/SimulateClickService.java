...
public class SimulateClickService extends AccessibilityService {
    ...
    private void findAddress() {
        ...
        if (lInWindow != null) {
            ...
            for (AccessibilityNodeInfo o :lViewById) {
                performClick(o);
                setELM(true);
                sleep();
                chooseAddress();
...
//        }
    ...
    private void chooseAddress() {
        ...
        for (AccessibilityNodeInfo i :
            ...
            for (AccessibilityNodeInfo j : lViewById) {
                Log.d(TAG, "地址:" + j.getText());
                if (j.getText().toString().contains("汉阳造")) {
                    performClick(i);
                    sleep();
                    findCate();
                }
...
//
    ...
    private void getDetails() {
        ...
        if (lNodeInfo != null) {
            ...
            List<AccessibilityNodeInfo> shopInfo = findViewById(lNodeInfo, "me.ele:id/anm");
            List<AccessibilityNodeInfo> brand = findViewById(lNodeInfo, "me.ele:id/agy");
            List<AccessibilityNodeInfo> phone = findViewById(lNodeInfo, "me.ele:id/anp");
